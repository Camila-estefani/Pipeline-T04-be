...
public class ProviderRest {
    ...
    @GetMapping("/v1/api/provider/state/{state}")
    ...
    @PostMapping("/v1/api/provider/save")
    ...
    @PutMapping("/v1/api/provider/update/{id}")
    ...
    @PatchMapping("/v1/api/provider/delete/{id}")
    ...
    @PatchMapping("/v1/api/provider/restore/{id}")
